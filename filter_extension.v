(***********************************************************************)
(*   This is part of filter extension, it is distributed under the     *)
...
Theorem Filter_Extension1 : ∀ G A, G <> Φ -> G ⊂ pow(A)
...
(* 集合A上的任何滤基都可扩张成为一个滤子 *)
Theorem Filter_Extension2 : ∀ B A, Ensemble A -> FilterBase B A
...
Theorem Filter_Extension_1_and_2 : ∀ G A, G <> Φ -> G ⊂ pow(A) -> Ensemble A
...
(* 滤子扩张原则: 任何滤子可以扩张成为超滤 *)
Theorem Filter_Extension3 : ∀ F A, Filter F A
...
Proof.
  ...
  apply Filter_Extension3 in H1 as [x[]]. exists x. apply FT2; auto.
Qed.
